				...
				<TR>
					...
					<TD class=Side vAlign=top align=right width="75%">
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TR>
									<TD class=head>
										<span style="float:left" class="TAG">博文管理</span>
							            <span style="float:right"><a href="#" onclick="bowenAdd()">[发博文] </a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
									</TD>
								</TR>
								<TR align="left">
									<TD height="5"></TD>
									...
									<TD>
									    <c:forEach items="${requestScope.bowenList}" var="bowen" varStatus="ss">
											<TABLE cellpadding="12" cellspacing="12">
												<TR>
													<td>
													  <font style="font-size: 17px;font-family: 幼圆">${ss.index+1 }.${bowen.title }</font>&nbsp;&nbsp;(${bowen.shijian })
													   &nbsp;&nbsp;&nbsp;<a href="#" onclick="bowenDel(${bowen.id })">[删除]</a>
													</td>
												</TR>
												<TR>
												...
												<tr>
												   <td>
												       <a href="#" onclick="pinglunMana(${bowen.id })">评论(${bowen.pinglunShu })</a>
												   </td>
												</tr>
												<tr>
												   <td>
