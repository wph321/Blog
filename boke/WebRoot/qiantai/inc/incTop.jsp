...
<html>
  ...
  <body>
        <div class="Header HeaderTop">
			<br/>
			<font style="font-size: 40px;color: white;font-weight: bolder;display: block;text-align: center;">多用户文章管理系统</font>
		</div>
		<div class="topmenu cbody1">
			<ul>
				...
				<li class="thisclass">
					<a target="_blank" href="<%=path %>/login.jsp">系统管理员登录</a>
				</li>
			</ul>
		</div>
		<form id="searchForm" action="<%=path %>/userSearch.action" method="post">
			<div class="topsearch">
				<div class="title"></div>
				<div id="page_search_left">
					<input onfocus="this.value=''" class="inputText" id="" size="16" name="userRealname" type="text" value="请输入博主昵称"/>
				</div>
