...
public class TPinglunDAO extends HibernateDaoSupport
{
	...
	public static final String SHJIAN = "shjian";

	public static final String BOWEN_ID = "bowenId";
	...
	public List findByShjian(Object shjian)
	{
		return findByProperty(SHJIAN, shjian);
	}

	public List findByBowenId(Object bowenId)
	{
		return findByProperty(BOWEN_ID, bowenId);
	}
